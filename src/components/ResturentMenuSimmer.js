...
const ResturentMenuSimmer = () => {    
    return(
        <div className="menu w-full flex justify-center pt-[90px]">
            <div className='w-11/12 sm:w-10/12 md:w-9/12 lg:w-6/12'>
                <h1 className='text-[#535665] pt-5 text-xs'></h1>
                <h1 className='font-bold text-3xl ml-4 pt-10'></h1>
                <div className='h-[265px] sm:h-60 p-4 bg-gradient-to-t from-gray-300 rounded-[30px]'>
                    <div className='w-12/12 h-[235px] sm:h-52 py-2 px-4 border-2 rounded-2xl bg-white '>
                        <h3 className='text-lg sm:text-xl flex items-center font-semibold'> </h3>
                        <p className='text-base text-red-500 ml-1 font-semibold'></p> 
                        <div className='pl-5 mt-2'>
                            <p className='text-base sm:text-lg font-semibold'><span className=' text-gray-400 ml-4 font-semibold'></span></p>
                            <p className='text-base sm:text-lg font-semibold'></p>
                        </div>
                        <hr className='my-4' />
                        <p className='text-base sm:text-lg font-semibold mr-4 flex items-center'> <IoIosBicycle className='mr-2' /> </p>
                    </div>
                </div>
...
export default ResturentMenuSimmer;
