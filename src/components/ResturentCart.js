...
const ResturentCart = (props) =>{
    ...
    return(
        <div data-testid="resCard" className="mt-8 w-64 h-auto rounded-md  hover:scale-105 duration-200" >
            ...
            <h4 className="my-1 text-gray-500 font-semibold ml-4 text-base w-full flex justify-between">{areaName} <span className="mr-5 font-semibold">{sla.lastMileTravelString}</span></h4>
        </div>
    )
}
