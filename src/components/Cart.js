    ...
    return(
        <div className="text-center p-4 pt-28">
            <div className="w-6/12 m-auto flex flex-col items-center justify-center">
                {cartItems.length !== 0 && <button className="p-2 m-2 text-red-600 rounded-lg text-3xl ml-auto" onClick={handleClearcart}><MdDelete /></button>}
                {cartItems.length === 0 && <img src={CART_IMG_URL} className="w-[271px] h-64" alt="Cart Img" />}
